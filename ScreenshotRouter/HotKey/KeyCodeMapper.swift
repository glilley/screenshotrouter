...
/// Translates between Carbon key codes / modifier masks and human-readable strings.
struct KeyCodeMapper {

    // MARK: - Display string from Carbon values

    static func displayString(keyCode: UInt32, carbonModifiers: UInt32) -> String {
        let mods = modifierString(carbonModifiers: carbonModifiers)
    ...
    static func nsModifiers(from carbonModifiers: UInt32) -> NSEvent.ModifierFlags {
    ...
    /// Convert NSEvent.ModifierFlags → Carbon modifier flags
    ...
    private static func modifierString(carbonModifiers: UInt32) -> String {
        var s = ""
